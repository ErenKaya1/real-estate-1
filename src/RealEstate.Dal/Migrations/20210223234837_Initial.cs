        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    M2Brut = table.Column<string>(maxLength: 20, nullable: false),
                    M2Net = table.Column<string>(maxLength: 20, nullable: false),
                    RoomCount = table.Column<string>(maxLength: 10, nullable: false),
                    FloorNumber = table.Column<string>(maxLength: 3, nullable: false),
                    TotalFloor = table.Column<string>(maxLength: 5, nullable: false),
                    BuildingStatus = table.Column<byte>(nullable: false),
                    SaleType = table.Column<byte>(nullable: false),
                    BuildingAge = table.Column<string>(maxLength: 5, nullable: false),
                    ...
                    BathroomCount = table.Column<string>(maxLength: 2, nullable: false),
                    ...
                    DescriptionTR = table.Column<string>(nullable: false),
                    DescriptionEN = table.Column<string>(nullable: false),
                    EstateTypeId = table.Column<int>(nullable: false),
                    ProvinceId = table.Column<int>(nullable: false),
                    DistrictId = table.Column<int>(nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "date", nullable: false),
                    GoogleMapIframe = table.Column<string>(maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
